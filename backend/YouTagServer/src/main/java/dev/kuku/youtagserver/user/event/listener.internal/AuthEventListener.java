package dev.kuku.youtagserver.user.event.listener.internal;

import dev.kuku.youtagserver.auth.events.api.GotUserFromTokenEvent;
import dev.kuku.youtagserver.user.entity.internal.User;
import dev.kuku.youtagserver.user.event.dispatcher.api.UserAddedEvent;
import dev.kuku.youtagserver.user.event.dispatcher.api.UserUpdatedEvent;
import dev.kuku.youtagserver.user.repo.internal.UserRepo;
