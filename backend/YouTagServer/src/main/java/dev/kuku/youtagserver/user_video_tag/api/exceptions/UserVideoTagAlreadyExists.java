...
public class UserVideoTagAlreadyExists extends ResponseException {
    public UserVideoTagAlreadyExists(String userId, String videoId, String tag) {
        super(HttpStatus.ALREADY_REPORTED, String.format("User Video Tag already exists %s %s %s", userId, videoId, tag));
    }
}
